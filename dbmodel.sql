...
ALTER TABLE `player` ADD `skip_roll_die` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'This player will NOT roll the die for next turn : 0/1';
...
CREATE TABLE IF NOT EXISTS `cards` (
  ...
  `card_played` tinyint(1) DEFAULT 0 COMMENT 'Is the card already played ?',
  PRIMARY KEY (`card_id`)
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
