...
final class ScoringTest extends TestCase
{
    ...
    //Test that cards still in hand does nt activate
    public function test_computeScoring_CityCard_Bribery_Nothing(): void
    {
        logTestRun(__CLASS__.".".__FUNCTION__);
        $game = new GameMock();
        GamestateMachine::$test_current_state = ST_END_SCORING;
        ...
        TestDatas::$cards[221]['type'] = CITY_CARD_TYPE::BRIBERY->value;
        $expectedNotifs = [
            "computeFinalScore",
            "revealCityCard-1",
            "scoreDeliveries-1", 
    ...
    public function test_computeScoring_CityCard_SharedCli_Automa_Leads(): void
    {
        logTestRun(__CLASS__.".".__FUNCTION__);
        $game = new GameMock();
        GamestateMachine::$test_current_state = ST_END_SCORING;
        ...
        TestDatas::$cards[221]['player_id'] = 1;
        TestDatas::$cards[221]['card_state'] = 1;
        TestDatas::$cards[221]['type'] = CITY_CARD_TYPE::SHARED_CLI->value;
        ...
        TestDatas::$cards[12]['player_id'] = AUTOMA_PLAYER_ID;
        TestDatas::$cards[13]['card_location'] = CARD_LOCATION_DELIVERED;
        TestDatas::$cards[13]['player_id'] = 2;
        $expectedNotifs = [
            "computeFinalScore",
            "deliver--123", 
            "deliver--123", 
        ...
        assertSame(0,  TestDatas::$players[1]['player_score_aux']);
        assertSame(23,  TestDatas::$players[2]['player_score']);//+2 Reduce to lowest score
        assertSame(0,  TestDatas::$players[2]['player_score_aux']);//REDUCED
        assertSame(7, Globals::getAutomaScore());
    }
    
    public function test_computeScoring_CityCard_SharedCli_Automa_Ties(): void
    {
        logTestRun(__CLASS__.".".__FUNCTION__);
        $game = new GameMock();
        GamestateMachine::$test_current_state = ST_END_SCORING;
        ...
        $endScoringDatas = Globals::getEndScoring();
        assertSame($expectedScoring, $endScoringDatas);
        assertSame(25,  TestDatas::$players[1]['player_score']);//19 + 6 Reduce to lowest score
        assertSame(0,  TestDatas::$players[1]['player_score_aux']);
        assertSame(25,  TestDatas::$players[2]['player_score']);//+2 Reduce to lowest score
        assertSame(0,  TestDatas::$players[2]['player_score_aux']);//REDUCED
        assertSame(3, Globals::getAutomaScore());
    }
    public function test_computeScoring_CityCard_SharedCli_Automa_Worst_KO(): void
    {
        ...
        TestDatas::$tokens[43] = ['result_associative_index' => 43, 'meeple_id' => 43, 'meeple_state' => 1, 'meeple_location'=> MEEPLE_LOCATION_HIDDEN_CARD."1-".CARD_TYPE_CITY."-1-".CARD_CITY_LOCATION_HAND,'type' => MEEPLE_TYPE_CLAN_MARKER,  'player_id' => AUTOMA_PLAYER_ID,  ];
        TestDatas::$cards[11]['card_location'] = CARD_LOCATION_DELIVERED;
        TestDatas::$cards[11]['player_id'] = 1;
        TestDatas::$cards[12]['card_location'] = CARD_LOCATION_DELIVERED;
        TestDatas::$cards[12]['player_id'] = 1;
        TestDatas::$cards[13]['card_location'] = CARD_LOCATION_DELIVERED;
        TestDatas::$cards[13]['player_id'] = 2;
        ...
        assertSame(0,  TestDatas::$players[1]['player_score_aux']);
        assertSame(24,  TestDatas::$players[2]['player_score']);//+2 Reduce to lowest score
        assertSame(0,  TestDatas::$players[2]['player_score_aux']);//REDUCED
        assertSame(0, Globals::getAutomaScore());
    ...
    public function test_computeScoring_CityCard_SharedEngineers_Automa_Ties(): void
    {
        ...
        public function test_computeScoring_CityCard_SharedEngineers_Automa_Worst_KO(): void
    {
        logTestRun(__CLASS__.".".__FUNCTION__);
        $game = new GameMock();
        GamestateMachine::$test_current_state = ST_END_SCORING;
        ...
        TestDatas::$cards[221]['type'] = CITY_CARD_TYPE::SHARED_ENG->value;
        TestDatas::$tokens[43] = ['result_associative_index' => 43, 'meeple_id' => 43, 'meeple_state' => 1, 'meeple_location'=> MEEPLE_LOCATION_HIDDEN_CARD."1-".CARD_TYPE_CITY."-1-".CARD_CITY_LOCATION_HAND,'type' => MEEPLE_TYPE_CLAN_MARKER,  'player_id' => AUTOMA_PLAYER_ID,  ];
        TestDatas::$tokens[41]['player_id'] = 2;
        TestDatas::$tokens[42]['player_id'] = 2;
        $expectedNotifs = [
            "computeFinalScore",
            "revealCityCard-1",
    ...
    public function test_computeScoring_CityCard_SharedEnvoys_beforeOtherShared_KO(): void
    {
        logTestRun(__CLASS__.".".__FUNCTION__);
        $game = new GameMock();
        GamestateMachine::$test_current_state = ST_END_SCORING;
        Globals::setOptionSeishin(OPTION_SEISHIN_LEVEL_1);
        Globals::setOptionCity(OPTION_CITY_OF_LIES_ON);
        TestDatas::$players[1]['player_score'] = 19;
        TestDatas::$players[2]['player_score'] = 22;
        TestDatas::$cards[221]['card_location'] = CARD_CITY_LOCATION_HAND;
        TestDatas::$cards[221]['player_id'] = 1;
        TestDatas::$cards[221]['card_state'] = 1;
        TestDatas::$cards[221]['type'] = CITY_CARD_TYPE::SHARED_ENG->value;
        ...
        TestDatas::$cards[222]['player_id'] = 2;
        TestDatas::$cards[222]['card_state'] = 2;
        TestDatas::$cards[222]['type'] = CITY_CARD_TYPE::SHARED_ENV->value;
        TestDatas::$tokens[44] = ['result_associative_index' => 44, 'meeple_id' => 44, 'meeple_state' => 1, 'meeple_location'=> MEEPLE_LOCATION_HIDDEN_CARD."2-".CARD_TYPE_CITY."-2-".CARD_CITY_LOCATION_HAND,'type' => MEEPLE_TYPE_CLAN_MARKER,  'player_id' => 1,  ];
        $expectedNotifs = [
            "computeFinalScore",
            "revealCityCard-2",
            "scoreCityCard-2",
        ...
        $endScoringDatas = Globals::getEndScoring();
        assertSame($expectedScoring, $endScoringDatas);
        assertSame(22,  TestDatas::$players[1]['player_score']);//19 + 4 Reduce to lowest score
        assertSame(0,  TestDatas::$players[1]['player_score_aux']);
        assertSame(22,  TestDatas::$players[2]['player_score']);//22 + 0 Reduce to lowest score
        assertSame(0,  TestDatas::$players[2]['player_score_aux']);//REDUCED
        assertSame(0, Globals::getAutomaScore());
    }
    
    public function test_computeScoring_CityCard_SharedEnvoys_beforeOtherShared_Pass(): void
    {
        logTestRun(__CLASS__.".".__FUNCTION__);
        $game = new GameMock();
        GamestateMachine::$test_current_state = ST_END_SCORING;
        Globals::setOptionSeishin(OPTION_SEISHIN_LEVEL_1);
        Globals::setOptionCity(OPTION_CITY_OF_LIES_ON);
        TestDatas::$players[1]['player_score'] = 23;
        TestDatas::$players[2]['player_score'] = 22;
        TestDatas::$cards[221]['card_location'] = CARD_CITY_LOCATION_HAND;
        TestDatas::$cards[221]['player_id'] = 1;
        TestDatas::$cards[221]['card_state'] = 1;
        ...
        $endScoringDatas = Globals::getEndScoring();
        assertSame($expectedScoring, $endScoringDatas);
        assertSame(26,  TestDatas::$players[1]['player_score']);//23 + 4 Reduce to lowest score
        assertSame(0,  TestDatas::$players[1]['player_score_aux']);
        assertSame(26,  TestDatas::$players[2]['player_score']);//22 + 4 Reduce to lowest score
        assertSame(0,  TestDatas::$players[2]['player_score_aux']);//REDUCED
        assertSame(0, Globals::getAutomaScore());
    }
    
    public function test_computeScoring_CityCard_SharedEnvoys_Automa_Pass(): void
    {
        logTestRun(__CLASS__.".".__FUNCTION__);
        $game = new GameMock();
        GamestateMachine::$test_current_state = ST_END_SCORING;
        Globals::setOptionSeishin(OPTION_SEISHIN_LEVEL_1);
        Globals::setOptionCity(OPTION_CITY_OF_LIES_ON);
        Globals::setAutomaScore(23);
        TestDatas::$players[1]['player_score'] = 21;
        TestDatas::$players[2]['player_score'] = 22;
        TestDatas::$cards[221]['card_location'] = CARD_CITY_LOCATION_HAND;
        TestDatas::$cards[221]['player_id'] = 1;
        TestDatas::$cards[221]['card_state'] = 1;
        ...
        TestDatas::$cards[222]['card_state'] = 2;
        TestDatas::$cards[222]['type'] = CITY_CARD_TYPE::SHARED_ENV->value;
        TestDatas::$tokens[44] = ['result_associative_index' => 44, 'meeple_id' => 44, 'meeple_state' => 1, 'meeple_location'=> MEEPLE_LOCATION_HIDDEN_CARD."2-".CARD_TYPE_CITY."-2-".CARD_CITY_LOCATION_HAND,'type' => MEEPLE_TYPE_CLAN_MARKER,  'player_id' => AUTOMA_PLAYER_ID,  ];
        $expectedNotifs = [
            "computeFinalScore",
            "revealCityCard-2",
            "scoreCityCard-2",
        ...
        $endScoringDatas = Globals::getEndScoring();
        assertSame($expectedScoring, $endScoringDatas);
        assertSame(25,  TestDatas::$players[1]['player_score']);//21 + 4 Reduce to lowest score
        assertSame(0,  TestDatas::$players[1]['player_score_aux']);
        assertSame(25,  TestDatas::$players[2]['player_score']);//22 + 4 Reduce to lowest score
        assertSame(0,  TestDatas::$players[2]['player_score_aux']);//REDUCED
        assertSame(23, Globals::getAutomaScore());
    }
        public function test_computeScoring_CityCard_SharedEnvoys_Automa_Ties(): void
    {
        logTestRun(__CLASS__.".".__FUNCTION__);
        $game = new GameMock();
        GamestateMachine::$test_current_state = ST_END_SCORING;
        ...
        Globals::setAutomaScore(23);
        TestDatas::$players[1]['player_score'] = 21;
        TestDatas::$players[2]['player_score'] = 23;
        TestDatas::$cards[221]['card_location'] = CARD_CITY_LOCATION_HAND;
        TestDatas::$cards[221]['player_id'] = 1;
        TestDatas::$cards[221]['card_state'] = 1;
        TestDatas::$cards[221]['type'] = CITY_CARD_TYPE::SHARED_ENG->value;
        ...
        assertSame(25,  TestDatas::$players[1]['player_score']);//21 + 4 Reduce to lowest score
        assertSame(0,  TestDatas::$players[1]['player_score_aux']);
        assertSame(25,  TestDatas::$players[2]['player_score']);//23 + 4 Reduce to lowest score
        assertSame(0,  TestDatas::$players[2]['player_score_aux']);//REDUCED
        assertSame(23, Globals::getAutomaScore());
    }
    ...
    public function test_computeScoring_CityCard_Kimono(): void
    {
        logTestRun(__CLASS__.".".__FUNCTION__);
        $game = new GameMock();
        GamestateMachine::$test_current_state = ST_END_SCORING;
        Globals::setOptionSeishin(OPTION_SEISHIN_LEVEL_1);
        Globals::setOptionCity(OPTION_CITY_OF_LIES_ON);
        TestDatas::$players[1]['resources'] = '{"1":6,"2":5,"3":4,"4":3,"5":2,"6":25}';
        TestDatas::$cards[221]['card_location'] = CARD_CITY_LOCATION_HAND;
        TestDatas::$cards[221]['player_id'] = 1;
        TestDatas::$cards[221]['card_state'] = 1;
        TestDatas::$cards[221]['type'] = CITY_CARD_TYPE::KIMONO_DRESS->value;
        TestDatas::$players[2]['player_score'] = 34;
        $expectedNotifs = [
            "computeFinalScore",
            "revealCityCard-1",
        ...
        assertSame(25,  TestDatas::$players[1]['player_score']);//19 + 6 Reduce to lowest score
        assertSame(0,  TestDatas::$players[1]['player_score_aux']);
        assertSame(25,  TestDatas::$players[2]['player_score']);//+0 Reduce to lowest score
        assertSame(0,  TestDatas::$players[2]['player_score_aux']);//REDUCED
        assertSame(0, Globals::getAutomaScore());
    }
    
    public function test_computeScoring_CityCard_CallToPort(): void
    {
        logTestRun(__CLASS__.".".__FUNCTION__);
        $game = new GameMock();
        GamestateMachine::$test_current_state = ST_END_SCORING;
        Globals::setOptionSeishin(OPTION_SEISHIN_LEVEL_1);
        Globals::setOptionCity(OPTION_CITY_OF_LIES_ON);
        TestDatas::$tiles[41]['type'] = 2; //BUILDING_TYPE_PORT
        TestDatas::$tiles[41]['tile_state'] = 1;
        TestDatas::$tokens[21]['meeple_state'] = 1;
        TestDatas::$cards[221]['card_location'] = CARD_CITY_LOCATION_HAND;
        TestDatas::$cards[221]['player_id'] = 1;
        TestDatas::$cards[221]['card_state'] = 1;
        TestDatas::$cards[221]['type'] = CITY_CARD_TYPE::CALL_TO_PORT->value;
        TestDatas::$players[2]['player_score'] = 29;
        $expectedNotifs = [
            "computeFinalScore",
            "revealCityCard-1",
    ...
    public function test_computeScoring_CityCard_ShrinePilgrimage(): void
    {
        logTestRun(__CLASS__.".".__FUNCTION__);
        $game = new GameMock();
        GamestateMachine::$test_current_state = ST_END_SCORING;
        Globals::setOptionSeishin(OPTION_SEISHIN_LEVEL_1);
        Globals::setOptionCity(OPTION_CITY_OF_LIES_ON);
        TestDatas::$tiles[41]['type'] = 20; //BUILDING_TYPE_SHRINE
        TestDatas::$tiles[41]['tile_state'] = 1;
        TestDatas::$tiles[42]['type'] = 21; //BUILDING_TYPE_SHRINE
        TestDatas::$tiles[42]['tile_state'] = 2;
        TestDatas::$tokens[21]['meeple_state'] = 1;
        TestDatas::$cards[221]['card_location'] = CARD_CITY_LOCATION_HAND;
        TestDatas::$cards[221]['player_id'] = 1;
        TestDatas::$cards[221]['card_state'] = 1;
        TestDatas::$cards[221]['type'] = CITY_CARD_TYPE::SHRINE_PIL->value;
        TestDatas::$players[2]['player_score'] = 29;
        $expectedNotifs = [
            "computeFinalScore",
            "revealCityCard-1",
    ...
    public function test_computeScoring_CityCard_Teahouse(): void
    {
        logTestRun(__CLASS__.".".__FUNCTION__);
        $game = new GameMock();
        GamestateMachine::$test_current_state = ST_END_SCORING;
        ...
        TestDatas::$cards[221]['player_id'] = 1;
        TestDatas::$cards[221]['card_state'] = 1;
        TestDatas::$cards[221]['type'] = CITY_CARD_TYPE::TEAHOUSE->value;
        TestDatas::$players[2]['player_score'] = 34;
        $expectedNotifs = [
            "computeFinalScore",
            "revealCityCard-1",
    ...
    public function test_computeScoring_CityCard_Sake(): void
    {
        logTestRun(__CLASS__.".".__FUNCTION__);
        $game = new GameMock();
        GamestateMachine::$test_current_state = ST_END_SCORING;
        ...
        TestDatas::$cards[221]['player_id'] = 1;
        TestDatas::$cards[221]['card_state'] = 1;
        TestDatas::$cards[221]['type'] = CITY_CARD_TYPE::SAKE_BREW->value;
        TestDatas::$players[2]['player_score'] = 34;
        $expectedNotifs = [
            "computeFinalScore",
            "revealCityCard-1",
