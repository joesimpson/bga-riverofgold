...
{  
  ...
  {
    return [
      1  => new CitySpace( 1,1, 1, [ BONUS_TYPE_CHOICE => 2, ] ),
      2  => new CitySpace( 1,2, 2, [ BONUS_TYPE_SECOND_MARKER_ON_BUILDING => 1,  ] ),
      3  => new CitySpace( 1,3, 1, [  ] ), //BONUS_TYPE_BUILDING_ROW_REWARDS
      4  => new CitySpace( 1,4, 2, [  ] ), //BONUS_TYPE_DELIVER_TOP
      
      5  => new CitySpace( 2,1, 3, [ RESOURCE_TYPE_MOON=>1, RESOURCE_TYPE_SUN => 1, ] ),
      6  => new CitySpace( 2,2, 4, [  ] ),
      7  => new CitySpace( 2,3, 3, [  ] ),
      8  => new CitySpace( 2,4, 4, [  ] ),

      9   => new CitySpace( 3,1, 5, [ RESOURCE_TYPE_MONEY => 7,  ] ),
      10  => new CitySpace( 3,2, 6, [ BONUS_TYPE_POINTS => 5, ] ),
      11  => new CitySpace( 3,3, 5, [  ] ),
      12  => new CitySpace( 3,4, 6, [  ] ),
    ];
  }
