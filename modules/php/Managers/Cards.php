...
class Cards extends \ROG\Helpers\Pieces
{
  ...
  public static function getCustomerCardsTypes()
  {
    ...
    return [
      ...
      37 => $f([CUSTOMER_TYPE_SMUGGLER, REGION_1,  [RESOURCE_TYPE_SILK=>1,    RESOURCE_TYPE_RICE=>2,    ],]), 
      38 => $f([CUSTOMER_TYPE_SMUGGLER, REGION_2,  [RESOURCE_TYPE_SILK=>2,    RESOURCE_TYPE_POTTERY=>1, ],]), 
      39 => $f([CUSTOMER_TYPE_SMUGGLER, REGION_3,  [RESOURCE_TYPE_RICE=>2,    RESOURCE_TYPE_POTTERY=>1, ],]), 
      40 => $f([CUSTOMER_TYPE_SMUGGLER, REGION_4,  [RESOURCE_TYPE_RICE=>1,    RESOURCE_TYPE_POTTERY=>2, ],]), 
      41 => $f([CUSTOMER_TYPE_SMUGGLER, REGION_5,  [RESOURCE_TYPE_SILK=>1,    RESOURCE_TYPE_POTTERY=>2, ],]), 
      42 => $f([CUSTOMER_TYPE_SMUGGLER, REGION_6,  [RESOURCE_TYPE_SILK=>2,    RESOURCE_TYPE_RICE=>1,    ],]), 
      43 => $f([CUSTOMER_TYPE_SHINDOSHI, REGION_1,   [RESOURCE_TYPE_SUN=>1,    RESOURCE_TYPE_SILK=>1,    RESOURCE_TYPE_POTTERY=>2, ],]), 
      44 => $f([CUSTOMER_TYPE_SHINDOSHI, REGION_2,   [RESOURCE_TYPE_SUN=>1,    RESOURCE_TYPE_RICE=>2,    RESOURCE_TYPE_POTTERY=>1, ],]), 
      45 => $f([CUSTOMER_TYPE_SHINDOSHI, REGION_3,   [RESOURCE_TYPE_SUN=>1,    RESOURCE_TYPE_RICE=>1,    RESOURCE_TYPE_POTTERY=>2, ],]), 
      46 => $f([CUSTOMER_TYPE_SHINDOSHI, REGION_4,   [RESOURCE_TYPE_SUN=>1,    RESOURCE_TYPE_SILK=>1,    RESOURCE_TYPE_RICE=>1,    RESOURCE_TYPE_POTTERY=>1, ],]), 
      47 => $f([CUSTOMER_TYPE_SHINDOSHI, REGION_5,   [RESOURCE_TYPE_SUN=>1,    RESOURCE_TYPE_SILK=>2,    RESOURCE_TYPE_RICE=>1,    ],]),
      48 => $f([CUSTOMER_TYPE_SHINDOSHI, REGION_6,   [RESOURCE_TYPE_SUN=>1,    RESOURCE_TYPE_SILK=>2,    RESOURCE_TYPE_RICE=>1,    ],]),
