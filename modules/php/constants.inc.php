...
const SCORE_FAIL = -1;
 ...
 const NB_INFLUENCE_TATTOOED_MONK = 1;
 const NB_INLUENCE_FLOWER = 11;
 const NB_INLUENCE_VOID = 1;
 const NB_INFLUENCE_SEISHIN_DELIVER = 3;
 const NB_BUILDINGS_WATER = 3;
 const NB_CUSTOMERS_FOR_AIR = 3;
 const NB_CUSTOMERS_FOR_FIRE = 2;
 const NB_SPACES_FOR_MASTERY_WAVES = 7;
 const NB_FAVOR_FOR_MASTERY_SUN_MOON = 5;
 const NB_POINTS_FOR_MASTERY_LIGHTNING = 30;
...
const CARD_TRADER_4   = 58;
const CARD_TRADER_5   = 59;
const CARD_TRADER_6   = 60;
...
const TILE_LOCATION_CITYSCORING_DECK = 'city_d';
const TILE_LOCATION_CITYSCORING_BOARD = 'city_b';
const TILE_LOCATION_MASTERY_CARD = 'm';
const TILE_LOCATION_MASTERY_DECK = 'm_deck';
...
const RESOURCE_TYPE_CITY_CARD  = 1001;
...
/**
 * array of [Column => Influence Cost]
 */
const CITY_LANTERNS = [
   1 => 1,
   2 => 1,
...
const CARD_CITY_LOCATION_DISCARD = 'city_dis';
...
const OPTION_SCENARIOS = 112;
const OPTION_SCENARIOS_OFF = 0;
const OPTION_SCENARIOS_ON  = 1;

const OPTION_CITY_OF_LIES = 113;
const OPTION_CITY_OF_LIES_OFF = 0;
const OPTION_CITY_OF_LIES_ON  = 1;
...
const OPTION_CUSTOMERS_TRADEFAVOR   = 1;
const OPTION_CUSTOMERS_INTOCITY     = 2;
const OPTION_CUSTOMERS_NIGHT_MONKS  = 3;
const OPTION_CUSTOMERS_BUILDING_INFLUENCE = 4;
const OPTION_CUSTOMERS_RANDOM       = 10;

const OPTION_MARKETS = 130;
const OPTION_MARKETS_BASE           = 0;
const OPTION_MARKETS_NIGHT          = 1;
const OPTION_MARKETS_RANDOM         = 10;
...
const ST_PLAYER_TURN_ADVANCE = 19;
...
const ST_BONUS_PAY_SHIPS = 33;
const ST_BONUS_ADVANCE_CITY = 34;
const ST_BONUS_SELECT_REGION = 35;
const ST_BONUS_MULTI_TRADES  = 36;
const ST_BONUS_MANAGE_CARD_RESOURCES = 37;
const ST_BONUS_FREE_BUILD = 38;
const ST_BONUS_FREE_SAIL = 39;
